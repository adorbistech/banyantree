...
export function exportCommand(): Command {
  return new Command('export')
    ...
    .action(async (opts: {
      ...
      print(`  Entities:      ${exportData.summary.entityCount}`)
      print(`  Relationships: ${exportData.summary.relationshipCount}`)
      print(`  Memories:      ${exportData.summary.memoryCount}`)
      print(`  Events:        ${exportData.summary.eventCount}`)
